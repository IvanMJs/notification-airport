...
const T55 = "rgba(232,232,240,.55)";
const T72 = "rgba(232,232,240,.72)";
...
export function PublicLinkScreen() {
  ...
  return (
    ...
    >
      {/* Title */}
      <div style={{ fontSize: 9, color: T55, letterSpacing: "0.12em", marginBottom: 24 }}>
      ...
      >
        <div style={{ fontSize: 9, color: A, letterSpacing: "0.1em", marginBottom: 12 }}>
          ◎ VISTA PÚBLICA
        </div>
        <div style={{ fontSize: 11, color: T72, lineHeight: 1.7 }}>
          Compartís un link con tu familia o amigos y ven en tiempo real:{" "}
          <span style={{ color: A }}>hora de salida, puerta, estado del vuelo.</span>
      ...
      <div style={{ marginBottom: 12 }}>
        <div style={{ fontSize: 8, color: T55, letterSpacing: "0.1em", marginBottom: 8 }}>TU LINK</div>
        <div
          style={{
            background: "rgba(255,255,255,.03)",
            border: `1px solid rgba(232,232,240,.20)`,
            borderRadius: 8,
            padding: "12px 14px",
            fontSize: 10,
            color: state === "loading" || state === "error" ? T55 : A,
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        <button
          ...
          style={{
            ...
            border: `1px solid rgba(232,232,240,.25)`,
            color: state === "copied" ? A : T72,
            fontFamily: MONO,
            fontSize: 12,
            fontWeight: 700,
            letterSpacing: "0.1em",
